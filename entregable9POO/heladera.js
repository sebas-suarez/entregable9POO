...
var heladera = /** @class */ (function (_super) {
    ...
    function heladera(pMarca, pModelo, pEstaEncendido, pTemperatura) {
        var _this = _super.call(this, pMarca, pModelo, pEstaEncendido) || this;
    ...
    heladera.prototype.cambiarTemperatura = function () {
        var nuevaTemperatura = rs.questionInt('Cual sera la nueva Temperatura? ');
